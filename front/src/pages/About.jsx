      ...
      <div className={s.container}>
        <header className={s.banner}>
          ...
          <div className={s.contact}>
            ...
            <ScrollAnimation animateIn="fadeInRight"className={s.image_banner}>
        ...
        <ScrollAnimation animateIn="fadeInLeft" className={s.image} >
          ...
          <ScrollAnimation animateIn="fadeIn" className={s.about_reverse} >
          ...
          <ScrollAnimation animateIn="fadeInRight" className={s.image_reverse} >
          <img src={big} alt="big"  />
          </ScrollAnimation>
          </ScrollAnimation>
          <ScrollAnimation animateIn="fadeIn" className={s.about_cat} >
