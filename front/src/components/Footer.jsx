    ...
    <footer className={s.footer_distributed}>
      <div className={s.footer_left}>
        ...
        <p className={s.footer_company_name}>
          Copyright © 2022 <strong>Calathea Market</strong> All rights reserved
        </p>
      </div>
      ...
      <div className={s.footer_center}>
        ...
        <div>
          ...
          <p>
            <a href="https://api-plants-b6153.web.app/contact%22%3Ecalathea_market@outlook.com">
              calatheaMarket@gmail.com
            </a>
          </p>
        </div>
      </div>
      <div className={s.footer_right}>
        <p className={s.footer_company_about}>
          ...
          lovers, we help you create an environment full of life with plants for
          all tastes such as easy care, pet friendly, indoor, outdoor, etc.
        </p>
