  ...
  return (
    <div>
      ...
      <select onChange={handleOnPeriod}>
        <option value="2022-09-10,2022-09-15">09/10 - 15/10</option>
        <option value="2022-10-16,2022-10-22">16/10 - 22/10</option>
        <option value="2022-10-23,2022-10-29">23/10 - 29/10</option>
        <option value="2022-10-30,2022-11-06">30/10 - 06/11</option>
        <option value="2022-11-07,2022-11-13">07/11 - 13/11</option>
