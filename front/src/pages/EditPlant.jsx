...
const EditPlant = () => {
    ...
    function handleOnSubmit(e) {
        ...
        const product = {
            ...
            // type: input.type,
            logicalDeletion: input.logicalDeletion !== plant.logicalDeletion ? input.logicalDeletion : plant.logicalDeletion
                        ...
                        <div className={s.container}>
                            ...
                            <form onSubmit={handleOnSubmit} className={s.form}>
                                ...
                                <div className={s.input_container}>
                                    <input type="text" name="name" placeholder="name" autoComplete='off' onChange={handleOnChange} />
                                    {error.name && <p className={s.errors}>{error.name}</p>}
                                </div>

                                <div className={s.input_container}>
                                    <input type="text" name="details" placeholder="details" autoComplete='off' onChange={handleOnChange} />
                                ...
                                <div className={s.input_container}>
                                    <label>Price: </label>
                                    <input type="number" name="price" placeholder="price" onChange={handlePrice} min="0" max="1000000" />
                                    {error.price && <p className={s.errors}>{error.price}</p>}
                                </div>

                                <div className={s.input_container}>
                                    <label>Stock: </label>
                                    <input type="number" name="stock" placeholder="stock" onChange={handleStock} min="0" max="1000000" />
                                    {error.stock && <p className={s.errors}>{error.stock}</p>}
                                </div>

                                <div>
                                    <label>Show: </label>
                                    <button type="button" onClick={handleShow}>Switch</button>
                                </div>
                                ...
                                <div>
                                    {input.size.length ?
                                        <div className={s.categories_option} >
                                            <button type="button" onClick={handleDeleteSize}>x</button>
                                            <p>{input.size[0]}</p>
                                        </div> : null
                                    }
                                </div>
